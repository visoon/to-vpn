...
extension VpnManager{
    ...
    fileprivate func createProviderManager() -> NETunnelProviderManager {
        ...
        conf.serverAddress = "To"
        manager.protocolConfiguration = conf
        manager.localizedDescription = "To VPN"
        return manager
    }
...
extension VpnManager{
    ...
    fileprivate func setRulerConfig(_ manager:NETunnelProviderManager){
        ...
        let lineConfig = TTLineCacheManager.manager.currentConfig()
        
        conf["ss_address"] = lineConfig.address as AnyObject
        conf["ss_port"] = lineConfig.port as AnyObject?
        conf["ss_method"] = lineConfig.method as AnyObject? // 大写 没有横杠 看Extension中的枚举类设定 否则引发fatal error
        conf["ss_password"] = lineConfig.password as AnyObject?
